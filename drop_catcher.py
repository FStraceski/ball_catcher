...
import imutils
import time
import kalmanFilter_filterpy2 as kalmanFilter_filterpy
...
while (1):
    ...
    if counter == 2 and initialized is False:
        ...
        x_0 = np.array([[x2], [(290 - y2)], [0], [0]]) / pix_per_meter
